    ...
    init: function() {     
     ...
     // Нажатие на кнопку - активности
      ...
      $('.admin-center').on('click', '.section-slider-action #add-plug-modal .additionalImage', function() {
         $('<li class="additionalImageContainer"><input type="text" class="additionalImageWidth" placeholder="ширина (px)" value=""/><input type="text" class="additionalImageSrc imgSrc" placeholder="ссылка на изображение" value=""/> <a href="javascript:void(0);" class="browseImage">выбрать изображение</a> </li>').insertAfter('.section-slider-action #add-plug-modal .fa-question-circle');
      });    
        ...
        if (undefined != srcSet) {
          if (srcSet.length > 1) {
            ...
            srcSetArr.forEach(function (index, value) {
              ...
              $('<li class="additionalImageContainer"><input type="text" class="additionalImageWidth" placeholder="ширина (px)" value=""/><input type="text" class="additionalImageSrc imgSrc" placeholder="ссылка на изображение" value=""/> <a href="javascript:void(0);" class="browseImage">выбрать изображение</a> </li>').appendTo('.type-img');
