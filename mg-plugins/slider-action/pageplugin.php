           ...
           <ul class="text-list">
            ...
            <div class="block-for-form" >
                <ul class="custom-form-wrapper type-img">
                    ...
                    <a class='tool-tip-top fa fa-question-circle' title='В новых браузерах список srcset ипользуется вместо атрибута src <br>(не забудьте добавить в список srcset основное изображение из src)<br> и содержит изображения различной ширины, <br>подставляющиеся в зависимости от ширины экрана пользователя.'></a>
                </ul>
