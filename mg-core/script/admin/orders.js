        ...
        if(typeof(response.data.deliveryArray) != "undefined") {
          $.each(response.data.deliveryArray, function (i, delivery) {
            ...
            if (delivery.activity == 1) {
              ...
              deliveryList += '<option value="' + delivery.cost + '" data-interval='+"'"+delivery.interval+"'"+' data-free="' + delivery.free + '" data-plugin="' + delivery.plugin + '" data-date="' + delivery.date + '" name="' + delivery.id + '" ' + selected + '>' + delivery.name + '</option>';
            }
          });
        }
