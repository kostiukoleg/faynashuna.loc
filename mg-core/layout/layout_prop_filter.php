		...
		if ($prop['type'] == 'select') {
			...
			foreach ($prop['data'] as $propData) {
				...
				switch ($propData['type']) {
					case 'active':
						echo ' <li style="'.$propData['style'].'"><label '.$propData['active'].'>'.$color.'<input  type="checkbox" name="prop['.$prop['idProp'].'][]" value="'.$propData['value_id'].'|'.$propData['value_type'].'" '.$propData['checked'].'  class="mg-filter-prop-checkbox"/>'.$propData['value_name'].'<span class="cbox"></span>&nbsp;<span class="unit"> '.$propData['value_unit'].'</span></label>'.$propData['viewAll'].'</li>';
						break;
					case 'normal':
						if($propData['img'] != '') {
							echo ' <li title="'.$propData['value_name'].'" '.(!empty($propData['color']) ? ' class="color-filter"' : '').' style="'.$propData['style'].'"><label>'.$color.'<input type="checkbox" name="prop['.$prop['idProp'].'][]" value="'.$propData['value_id'].'|'.$propData['value_type'].'" '.$propData['checked'].'  class="mg-filter-prop-checkbox"/><span class="value-name">'.$propData['value_name'].'</span><span class="cbox" style="background: url('.SITE.'/'.$propData['img'].');background-size:cover;"></span>&nbsp;<span class="unit"> '.$propData['value_unit'].'</span></label></li>'.$propData['viewAll'];
						} else {
							echo ' <li title="'.$propData['value_name'].'" '.(!empty($propData['color']) ? ' class="color-filter"' : '').' style="'.$propData['style'].'"><label>'.$color.'<input type="checkbox" name="prop['.$prop['idProp'].'][]" value="'.$propData['value_id'].'|'.$propData['value_type'].'" '.$propData['checked'].'  class="mg-filter-prop-checkbox"/><span class="value-name">'.$propData['value_name'].'</span><span class="cbox" style="background-color: '.$propData['color'].'"></span>&nbsp;<span class="unit"> '.$propData['value_unit'].'</span></label></li>'.$propData['viewAll'];
						}
						break;
					case 'slider|easy':
					case 'slider|hard':
					...
					default:
						if($propData['img'] != '') {
							echo ' <li title="'.$propData['value_name'].'" '.(!empty($propData['color']) ? ' class="color-filter disabled"' : '').' style="'.$propData['style'].'"><label class="disabled-prop">'.$color.'<input disabled type="checkbox" name="prop['.$prop['idProp'].'][]" value="'.$propData['value_id'].'|'.$propData['value_type'].'" '.$propData['checked'].'  class="mg-filter-prop-checkbox"/><span class="value-name">'.$propData['value_name'].'</span><span class="cbox" style="background: url('.SITE.'/'.$propData['img'].');background-size:cover;"></span>&nbsp;<span class="unit"> '.$propData['value_unit'].'</span></label></li>'.$propData['viewAll'];
						} else {
							echo ' <li title="'.$propData['value_name'].'" '.(!empty($propData['color']) ? ' class="color-filter disabled"' : '').' style="'.$propData['style'].'"><label class="disabled-prop">'.$color.'<input disabled type="checkbox" name="prop['.$prop['idProp'].'][]" value="'.$propData['value_id'].'|'.$propData['value_type'].'" '.$propData['checked'].'  class="mg-filter-prop-checkbox"/><span class="value-name">'.$propData['value_name'].'</span><span class="cbox" style="background-color: '.$propData['color'].'"></span>&nbsp;<span class="unit"> '.$propData['value_unit'].'</span></label></li>'.$propData['viewAll'];
						}
