<div class="product-wrapper" <?php if(MG::get('controller')!=="controllers_product"): ?>
itemscope itemtype="http://schema.org/Product"<?php endif; ?>>
    ...
    <div class="product-footer clearfix">
        <div class="clearfix">
            ...
            <span class="product-old-price" <?php echo (!$data['item']['old_price'])?'style="display:none"':'' ?>>
                <?php echo $data['item']['old_price']; ?> <?php echo $data['currency']; ?>
            </span>
            <?php endif; ?>
            <span class="product-price" <?php if(MG::get('controller')!=="controllers_product"): ?> itemprop="price" content="<?php echo MG::numberDeFormat($data['item']["price"]);?>"<?php endif; ?>><?php echo priceFormat($data['item']["price"]) ?></span> <span <?php if(MG::get('controller')!=="controllers_product"): ?> itemprop="priceCurrency"<?php endif; ?>><?php echo $data['currency']; ?></span>
