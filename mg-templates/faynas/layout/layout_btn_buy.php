<a href="<?php echo SITE.'/catalog?inCartProductId='.$data["id"];?>" rel="nofollow" class="addToCart buy-product buy" data-item-id="<?php echo $data["id"];?>"><?php echo lang('buttonBuy'); ?></a>
