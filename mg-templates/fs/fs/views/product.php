                    ...
                    <div class="l-col min-0--12">
                        <div class="c-tab">
                            <div class="c-tab__nav">
                                ...
                                <a class="c-tab__link c-tab__link--active" href="#c-tab__property"><?php echo lang('productCharacteristics'); ?></a>
                              	<a class="c-tab__link" href="#c-tab__tab1"><?php echo lang('productDescription'); ?></a>
                              	<?php else: ?>
							...
							<?php if(!empty($data['stringsProperties'])): ?>
                            <div class="c-tab__content" id="c-tab__tab1" itemprop="description">
                           ...
                           <?php endif; ?>
                            ...
                            <?php if(!empty($data['stringsProperties'])): ?>
                                <div class="c-tab__content c-tab__content--active" id="c-tab__property">
